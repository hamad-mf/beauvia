<x-layouts.dashboard title="Manage Services">
    <x-slot:sidebar>
        ...
        <a href="{{ route('freelancer.bookings') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-dark-300 hover:text-white hover:bg-white/5">📅 Bookings</a>
        <a href="{{ route('freelancer.services') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm bg-primary-600/20 text-primary-300">📦 Services</a>
    </x-slot:sidebar>
