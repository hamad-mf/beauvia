    ...
    <section class="pt-28 pb-20 min-h-screen">
        <div class="max-w-2xl mx-auto px-4">
            <div class="text-center mb-8">
                <h1 class="font-display text-3xl font-bold text-white mb-2">Setup Your Profile</h1>
                <p class="text-dark-400">Create your freelancer profile to start receiving bookings</p>
            </div>
