    ...
    <section class="pt-28 pb-20 min-h-screen">
        <div class="max-w-2xl mx-auto px-4">
            <div class="text-center mb-8">
                <h1 class="font-display text-3xl font-bold text-gray-900 mb-2">Setup Your Shop</h1>
                <p class="text-gray-500">Tell us about your business to get started</p>
            </div>
            <div class="glass-card p-8">
                <form method="POST" action="{{ route('shop.setup') }}" class="space-y-5">
                    @csrf
                    <div>
                        <label class="text-gray-700 text-sm mb-2 block">Shop Name</label>
                    ...
                    <div>
                        <label class="text-gray-700 text-sm mb-2 block">Description</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="text-gray-700 text-sm mb-2 block">Email (optional)</label>
